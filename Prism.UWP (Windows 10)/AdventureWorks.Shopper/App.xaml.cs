...
namespace AdventureWorks.Shopper
{
    ...
    public sealed partial class App : PrismUnityApplication
    {
        ...
        protected override Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            Container.RegisterType<IProductCatalogService, ProductCatalogServiceGeneratedProxy>(new ContainerControlledLifetimeManager());
            Container.RegisterType<IOrderService, OrderServiceGeneratedProxy>(new ContainerControlledLifetimeManager());
            Container.RegisterType<IShoppingCartService, ShoppingCartServiceGeneratedProxy>(new ContainerControlledLifetimeManager());
            Container.RegisterType<IShippingMethodService, ShippingMethodServiceGeneratedProxy>(new ContainerControlledLifetimeManager());
            Container.RegisterType<IIdentityService, IdentityServiceGeneratedProxy>(new ContainerControlledLifetimeManager());
            Container.RegisterType<ILocationService, LocationServiceGeneratedProxy>(new ContainerControlledLifetimeManager());
            Container.RegisterType<IAddressService, AddressServiceGeneratedProxy>(new ContainerControlledLifetimeManager());
            Container.RegisterType<IPaymentMethodService, PaymentMethodServiceGeneratedProxy>(new ContainerControlledLifetimeManager());

            Container.RegisterType<IWebApiProxyFactory, WebApiProxyFactory>(new ContainerControlledLifetimeManager());
