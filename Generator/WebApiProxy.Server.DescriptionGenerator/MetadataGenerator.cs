...
namespace WebApiProxy.Server.MetadataGenerator
{
    public class MetadataGenerator
    {
        ...
        public MetadataGenerator(HttpConfiguration configuration)
        {
            _configuration = configuration;
            _documentationProvider = _configuration.Services.GetDocumentationProvider();
        }
        ...
        private ParameterDescription GetBodyParameter(ApiDescription apiDescription)
        {
            ...
            var result = new ParameterDescription
            {
                ...
                Documentation = bodyParameter.Documentation
            };
